...
| Property   | Type       | Required | Description | Reference |
|------------|------------|-----|-------------|-----------|
| trigger | `RequestObjectDetector | ResponseIsSuccessfulDetector | SchemaPathRefDetector | RequestBodyTextDetector | ResponseBodyTextDetector | ResponseBodyJSONDetector | CrudDetector | RequestIsAuthenticatedDetector | ScanTypeDetector | ResponseHeadersDetector | SchemaUrlDetector | RequestHeadersDetector | ResponseStatusCodeDetector | RequestUserDetector | RequestBodyJSONDetector | ResponseDurationDetector | SchemaNeedAuthenticationDetector | ResponseObjectDetector` | `True` | The detectors to trigger the transform, on the request or response. See [Detectors](./detectors) |  |
| mutate | `RequestObjectMutator | RequestUserMutator | SchemaUrlMutator | RequestBodyTextMutator | RequestBodyJSONMutator | RequestHeadersMutator` | `True` | The mutations to apply to the request and replay it. See [Mutators](./mutators) |  |
