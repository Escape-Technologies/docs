...
| Property   | Type       | Required | Description | Reference |
|------------|------------|-----|-------------|-----------|
| trigger | `SchemaPathRefDetector | ResponseDurationDetector | RequestUserDetector | ResponseStatusCodeDetector | RequestHeadersDetector | ResponseBodyTextDetector | ScanTypeDetector | ResponseHeadersDetector | CrudDetector | SchemaNeedAuthenticationDetector | SchemaUrlDetector | RequestBodyTextDetector | RequestObjectDetector | ResponseIsSuccessfulDetector | RequestBodyJSONDetector | RequestIsAuthenticatedDetector | ResponseBodyJSONDetector | ResponseObjectDetector` | `True` | The detectors to trigger the transform, on the request or response. See [Detectors](./detectors) |  |
| mutate | `RequestBodyTextMutator | RequestObjectMutator | RequestHeadersMutator | RequestBodyJSONMutator | SchemaUrlMutator | RequestUserMutator` | `True` | The mutations to apply to the request and replay it. See [Mutators](./mutators) |  |
