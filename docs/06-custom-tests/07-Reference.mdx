...
| Property   | Type       | Required | Description | Reference |
|------------|------------|-----|-------------|-----------|
| trigger | `CrudDetector | ResponseIsSuccessfulDetector | SchemaUrlDetector | ResponseBodyTextDetector | ResponseHeadersDetector | ResponseObjectDetector | SchemaNeedAuthenticationDetector | ScanTypeDetector | RequestBodyJSONDetector | SchemaPathRefDetector | RequestHeadersDetector | RequestBodyTextDetector | RequestObjectDetector | ResponseBodyJSONDetector | RequestUserDetector | ResponseDurationDetector | RequestIsAuthenticatedDetector | ResponseStatusCodeDetector` | `True` | The detectors to trigger the transform, on the request or response. See [Detectors](./detectors) |  |
| mutate | `SchemaUrlMutator | RequestObjectMutator | RequestUserMutator | RequestBodyJSONMutator | RequestHeadersMutator | RequestBodyTextMutator` | `True` | The mutations to apply to the request and replay it. See [Mutators](./mutators) |  |
