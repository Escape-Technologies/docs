...
| Property   | Type       | Required | Description | Reference |
|------------|------------|-----|-------------|-----------|
| trigger | `RequestBodyTextDetector | RequestUserDetector | RequestObjectDetector | SchemaNeedAuthenticationDetector | ResponseStatusCodeDetector | CrudDetector | ScanTypeDetector | SchemaPathRefDetector | ResponseDurationDetector | RequestHeadersDetector | ResponseHeadersDetector | ResponseIsSuccessfulDetector | ResponseObjectDetector | RequestIsAuthenticatedDetector | SchemaUrlDetector | RequestBodyJSONDetector | ResponseBodyJSONDetector | ResponseBodyTextDetector` | `True` | The detectors to trigger the transform, on the request or response. See [Detectors](./detectors) |  |
| mutate | `RequestObjectMutator | SchemaUrlMutator | RequestHeadersMutator | RequestBodyJSONMutator | RequestBodyTextMutator | RequestUserMutator` | `True` | The mutations to apply to the request and replay it. See [Mutators](./mutators) |  |
