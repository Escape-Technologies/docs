...
| Property   | Type       | Required | Description | Reference |
|------------|------------|-----|-------------|-----------|
| trigger | `CrudDetector | SchemaPathRefDetector | RequestBodyJSONDetector | RequestUserDetector | SchemaUrlDetector | RequestBodyTextDetector | ResponseDurationDetector | RequestObjectDetector | RequestIsAuthenticatedDetector | ResponseBodyTextDetector | ResponseBodyJSONDetector | RequestHeadersDetector | ResponseObjectDetector | ScanTypeDetector | SchemaNeedAuthenticationDetector | ResponseHeadersDetector | ResponseStatusCodeDetector | ResponseIsSuccessfulDetector` | `True` | The detectors to trigger the transform, on the request or response. See [Detectors](./detectors) |  |
| mutate | `RequestBodyTextMutator | RequestUserMutator | RequestObjectMutator | RequestHeadersMutator | RequestBodyJSONMutator | SchemaUrlMutator` | `True` | The mutations to apply to the request and replay it. See [Mutators](./mutators) |  |
