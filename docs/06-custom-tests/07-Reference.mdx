...
| Property | Type              | Required | Description                                                                                                  | Reference |
| -------- | ----------------- | -------- | ------------------------------------------------------------------------------------------------------------ | --------- |
| protocol | `Const[http_raw]` | `False`  | The HTTP seeder allows you to send a request at the start of the scan.                                       |           |
