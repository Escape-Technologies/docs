...
| Property   | Type       | Required | Description | Reference |
|------------|------------|-----|-------------|-----------|
| trigger | `RequestBodyTextDetector | ResponseObjectDetector | ResponseIsSuccessfulDetector | RequestBodyJSONDetector | CrudDetector | ResponseBodyTextDetector | ResponseDurationDetector | SchemaPathRefDetector | ScanTypeDetector | SchemaUrlDetector | RequestHeadersDetector | ResponseBodyJSONDetector | RequestObjectDetector | ResponseHeadersDetector | ResponseStatusCodeDetector | SchemaNeedAuthenticationDetector | RequestUserDetector | RequestIsAuthenticatedDetector` | `True` | The detectors to trigger the transform, on the request or response. See [Detectors](./detectors) |  |
| mutate | `RequestBodyJSONMutator | RequestBodyTextMutator | RequestUserMutator | SchemaUrlMutator | RequestObjectMutator | RequestHeadersMutator` | `True` | The mutations to apply to the request and replay it. See [Mutators](./mutators) |  |
