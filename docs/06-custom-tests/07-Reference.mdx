...
| Property   | Type       | Required | Description | Reference |
|------------|------------|-----|-------------|-----------|
| trigger | `CrudDetector | RequestHeadersDetector | ScanTypeDetector | ResponseBodyTextDetector | ResponseHeadersDetector | ResponseObjectDetector | RequestBodyTextDetector | ResponseIsSuccessfulDetector | RequestObjectDetector | ResponseBodyJSONDetector | ResponseStatusCodeDetector | RequestBodyJSONDetector | RequestIsAuthenticatedDetector | SchemaNeedAuthenticationDetector | SchemaUrlDetector | RequestUserDetector | SchemaPathRefDetector | ResponseDurationDetector` | `True` | The detectors to trigger the transform, on the request or response. See [Detectors](./detectors) |  |
| mutate | `RequestObjectMutator | RequestHeadersMutator | SchemaUrlMutator | RequestBodyJSONMutator | RequestBodyTextMutator | RequestUserMutator` | `True` | The mutations to apply to the request and replay it. See [Mutators](./mutators) |  |
