...
| Property   | Type       | Required | Description | Reference |
|------------|------------|-----|-------------|-----------|
| trigger | `ResponseHeadersDetector | ResponseDurationDetector | SchemaNeedAuthenticationDetector | ResponseObjectDetector | RequestBodyTextDetector | ResponseIsSuccessfulDetector | RequestUserDetector | CrudDetector | ScanTypeDetector | SchemaUrlDetector | ResponseBodyJSONDetector | RequestHeadersDetector | ResponseBodyTextDetector | SchemaPathRefDetector | RequestIsAuthenticatedDetector | ResponseStatusCodeDetector | RequestBodyJSONDetector | RequestObjectDetector` | `True` | The detectors to trigger the transform, on the request or response. See [Detectors](./detectors) |  |
| mutate | `RequestObjectMutator | RequestHeadersMutator | RequestUserMutator | RequestBodyTextMutator | SchemaUrlMutator | RequestBodyJSONMutator` | `True` | The mutations to apply to the request and replay it. See [Mutators](./mutators) |  |
