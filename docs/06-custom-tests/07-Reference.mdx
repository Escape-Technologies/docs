...
| Property   | Type       | Required | Description | Reference |
|------------|------------|-----|-------------|-----------|
| trigger | `RequestBodyTextDetector | RequestHeadersDetector | CrudDetector | ResponseDurationDetector | ScanTypeDetector | ResponseBodyJSONDetector | RequestUserDetector | RequestBodyJSONDetector | SchemaUrlDetector | ResponseObjectDetector | ResponseIsSuccessfulDetector | ResponseHeadersDetector | ResponseStatusCodeDetector | SchemaNeedAuthenticationDetector | RequestIsAuthenticatedDetector | ResponseBodyTextDetector | SchemaPathRefDetector | RequestObjectDetector | MethodDetector` | `True` | The detectors to trigger the transform, on the request or response. See [Detectors](./detectors) |  |
| mutate | `MethodMutator | RequestBodyTextMutator | RequestObjectMutator | RequestBodyJSONMutator | RequestUserMutator | SchemaUrlMutator | RequestHeadersMutator | SchemaPathRefMutator` | `True` | The mutations to apply to the request and replay it. See [Mutators](./mutators) |  |
