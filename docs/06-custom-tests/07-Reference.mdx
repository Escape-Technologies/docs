...
| Property   | Type       | Required | Description | Reference |
|------------|------------|-----|-------------|-----------|
| trigger | `RequestUserDetector | CrudDetector | ResponseHeadersDetector | SchemaUrlDetector | ResponseIsSuccessfulDetector | ResponseDurationDetector | RequestIsAuthenticatedDetector | ResponseBodyJSONDetector | ResponseStatusCodeDetector | RequestBodyJSONDetector | SchemaNeedAuthenticationDetector | ScanTypeDetector | SchemaPathRefDetector | ResponseBodyTextDetector | RequestHeadersDetector | RequestObjectDetector | RequestBodyTextDetector | ResponseObjectDetector` | `True` | The detectors to trigger the transform, on the request or response. See [Detectors](./detectors) |  |
| mutate | `RequestObjectMutator | SchemaUrlMutator | RequestUserMutator | RequestBodyJSONMutator | RequestBodyTextMutator | RequestHeadersMutator` | `True` | The mutations to apply to the request and replay it. See [Mutators](./mutators) |  |
