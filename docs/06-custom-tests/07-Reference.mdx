...
| Property   | Type       | Required | Description | Reference |
|------------|------------|-----|-------------|-----------|
| trigger | `ResponseHeadersDetector | CrudDetector | RequestIsAuthenticatedDetector | ResponseBodyTextDetector | SchemaUrlDetector | ResponseObjectDetector | ResponseIsSuccessfulDetector | ScanTypeDetector | SchemaPathRefDetector | RequestHeadersDetector | RequestUserDetector | ResponseBodyJSONDetector | RequestBodyJSONDetector | ResponseStatusCodeDetector | ResponseDurationDetector | SchemaNeedAuthenticationDetector | RequestObjectDetector | RequestBodyTextDetector` | `True` | The detectors to trigger the transform, on the request or response. See [Detectors](./detectors) |  |
| mutate | `RequestObjectMutator | RequestBodyTextMutator | RequestBodyJSONMutator | RequestHeadersMutator | RequestUserMutator | SchemaUrlMutator` | `True` | The mutations to apply to the request and replay it. See [Mutators](./mutators) |  |
