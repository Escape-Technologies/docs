...
| Property   | Type       | Required | Description | Reference |
|------------|------------|-----|-------------|-----------|
| trigger | `RequestBodyTextDetector | CrudDetector | RequestObjectDetector | ResponseDurationDetector | RequestBodyJSONDetector | SchemaNeedAuthenticationDetector | ResponseBodyJSONDetector | ResponseObjectDetector | RequestHeadersDetector | SchemaUrlDetector | ScanTypeDetector | ResponseIsSuccessfulDetector | RequestIsAuthenticatedDetector | RequestUserDetector | MethodDetector | ResponseHeadersDetector | SchemaPathRefDetector | ResponseStatusCodeDetector | ResponseBodyTextDetector` | `True` | The detectors to trigger the transform, on the request or response. See [Detectors](./detectors) |  |
| mutate | `RequestHeadersMutator | RequestBodyJSONMutator | SchemaUrlMutator | RequestUserMutator | RequestObjectMutator | RequestBodyTextMutator | SchemaPathRefMutator | MethodMutator` | `True` | The mutations to apply to the request and replay it. See [Mutators](./mutators) |  |
