...
| Property   | Type       | Required | Description | Reference |
|------------|------------|-----|-------------|-----------|
| trigger | `ResponseIsSuccessfulDetector | CrudDetector | RequestObjectDetector | ResponseObjectDetector | SchemaUrlDetector | SchemaNeedAuthenticationDetector | ResponseBodyJSONDetector | RequestIsAuthenticatedDetector | RequestHeadersDetector | RequestBodyJSONDetector | RequestUserDetector | ResponseBodyTextDetector | ResponseDurationDetector | ScanTypeDetector | RequestBodyTextDetector | ResponseStatusCodeDetector | ResponseHeadersDetector | SchemaPathRefDetector` | `True` | The detectors to trigger the transform, on the request or response. See [Detectors](./detectors) |  |
| mutate | `RequestHeadersMutator | RequestUserMutator | RequestObjectMutator | RequestBodyTextMutator | RequestBodyJSONMutator | SchemaUrlMutator` | `True` | The mutations to apply to the request and replay it. See [Mutators](./mutators) |  |
