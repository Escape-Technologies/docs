...
| if | `Const[request.method]` | `False` | Use this to select against the request [HTTP method]([developer.mozilla.org](https://developer.mozilla.org/en-US/docs/Web/HTTP/Methods).) |  |
...
| Property   | Type       | Required | Description | Reference |
|------------|------------|-----|-------------|-----------|
| key | `Const[request.method]` | `False` | You can use this mutator to change the [HTTP method]([developer.mozilla.org](https://developer.mozilla.org/en-US/docs/Web/HTTP/Methods)) of the |  |
...
| Property   | Type       | Required | Description | Reference |
|------------|------------|-----|-------------|-----------|
| trigger | `SchemaPathRefDetector | RequestObjectDetector | ResponseIsSuccessfulDetector | ResponseStatusCodeDetector | RequestIsAuthenticatedDetector | MethodDetector | ResponseBodyTextDetector | ResponseHeadersDetector | SchemaNeedAuthenticationDetector | SchemaUrlDetector | ResponseObjectDetector | RequestUserDetector | ScanTypeDetector | RequestBodyJSONDetector | CrudDetector | RequestHeadersDetector | RequestBodyTextDetector | ResponseDurationDetector | ResponseBodyJSONDetector` | `True` | The detectors to trigger the transform, on the request or response. See [Detectors](./detectors) |  |
| mutate | `RequestBodyJSONMutator | MethodMutator | SchemaUrlMutator | SchemaPathRefMutator | RequestHeadersMutator | RequestUserMutator | RequestBodyTextMutator | RequestObjectMutator` | `True` | The mutations to apply to the request and replay it. See [Mutators](./mutators) |  |
