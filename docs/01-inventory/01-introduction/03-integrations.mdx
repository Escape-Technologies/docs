...
| **Developer Integration** | GitHub, GitLab, Postman | GitHub and GitLab serve as input for the API Discovery from Code and API Schema Generation, which feed into brute-forcing in Escape API Inventory. |
...
| **Catalogs & ASPM (Beta)** | Enso Security, Wiz, Ox Security, Apiiro | Serve to feed brute-forcing in Escape API Inventory, and enhances fingerprinting accuracy by contributing detailed application and API metadata. |
