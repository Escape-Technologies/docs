...
- **Repeater Agent**: Optionally, you can install the Repeater Agent within your network to detect and catalog internal APIs and secrets. This lightweight agent can be set up in just a few minutes and works across all standard networks.
