...
Especially, scans triggered using this method will use the application configuration on the [Escape platform](https://app.escape.tech). It will notify your team at the end using whatever contact channels that were defined for this organization (see [integrations](/dast/integrations)).
