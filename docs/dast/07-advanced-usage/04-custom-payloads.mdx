...
Escape operates on a [comprehensive scalar architecture](/dast/advanced-usage/data-types-reference), granting users the power to define their own data types or override existing ones via the `escaperc`
