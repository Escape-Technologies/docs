...
Any of the options you pass to the `GraphQLModule.forRoot` method is part of the Apollo configuration object. Thus, you can re-use the [Apollo plugin method](/cookbooks/enabling-introspection#using-apollo) for a fine-tuned access control.
...
You can do this automatically with a tool like [Apollo Rover CLI](https://www.apollographql.com/docs/rover/):
