...
You can view the supported list of scalars at (https://docs.escape.tech/advanced-usage/data-types-reference)[https://docs.escape.tech/advanced-usage/data-types-reference]
```yaml
          - request_scalar:
              kind: 'EMAIL'
              regex: '(.*)@escape.tech'
