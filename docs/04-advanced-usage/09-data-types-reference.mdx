...
|Name|Description|Sensitivity|
|----|-----------|-----------|
|xss_payload|XSS Payload|<span className="high-severity">HIGH</span>|
...
|latitude|Latitude geolocation|<span className="low-severity">LOW</span>|
|legal_name|Full legal name|<span className="low-severity">LOW</span>|
|longitude|Longitude geolocation|<span className="low-severity">LOW</span>|
...
|authress_service_client_access_key|Authress Service Client Access Key|<span className="high-severity">HIGH</span>|
...
|defined_networking_api_token|Defined Networking API token|<span className="high-severity">HIGH</span>|
...
|dropbox_api_key|Dropbox API secret/key|<span className="high-severity">HIGH</span>|
...
|facebook_token|Facebook Access Token|<span className="high-severity">HIGH</span>|
...
|flutterwave_public_key|Flutterwave Public Key|<span className="high-severity">HIGH</span>|
...
|gcp_service_account|Google (GCP) Service-account|<span className="high-severity">HIGH</span>|
...
|intercom_client_secret|Intercom client secret/ID|<span className="high-severity">HIGH</span>|
|ionic_api_token|Ionic API token|<span className="high-severity">HIGH</span>|
...
|openssh_pk|SSH private key|<span className="high-severity">HIGH</span>|
|pgp_pk|PGP private key|<span className="high-severity">HIGH</span>|
|pkcs8_pk|PKCS8 private key|<span className="high-severity">HIGH</span>|
...
|rsa_pk|RSA private key|<span className="high-severity">HIGH</span>|
...
|ssh_dsa_pk|SSH (DSA) private key|<span className="high-severity">HIGH</span>|
|ssh_ec_pk|SSH (EC) private key|<span className="high-severity">HIGH</span>|
...
|slug|Slug|<span className="low-severity">LOW</span>|
