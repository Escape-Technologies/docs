...
Refer to the [Authentication](/api-testing/authentication/) section for more information.
...
Scans can be slowed down using [rate-limiting configuration](/api-testing/advanced-usage/rate-limiting), though it may impact the scan duration.
