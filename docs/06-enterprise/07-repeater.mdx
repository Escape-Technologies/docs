...
3. Follow the deployment intrusctions directly in the Network page.
4. The connection status is refreshed every minute in the **Last seen** column.


### Use the repeater on a new application
...
### Use a repeater in an existing application.
