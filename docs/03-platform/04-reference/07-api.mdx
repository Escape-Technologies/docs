...
```json
{
  ...
  // Other settings
  "authentication": { // authentication details as documented in https://docs.escape.tech/api-testing/authentication/#overall-structure-of-an-authentication-configuration
    "presets": [
      {
        "type": "headers",
        "users": [
  ...
  "fullConfiguration": { // full expert configuration as documented in https://docs.escape.tech/api-testing/ci-cd/configuration-override and https://docs.escape.tech/api-testing/advanced-usage/
