...
We recommend you also validate the ips by simply doing the command:

```sh
nslookup repeater.escape.tech
```

| Address                | Protocol      | Port  |
| ---------------------- | ------------- | ----- |
| `repeater.escape.tech` | `TCP`/`RPC`   | `443` |
| `52.6.17.196`       | `TCP`/`HTTP`  | `80`  |
| `52.6.17.196`       | `TCP`/`HTTP`  | `443`  |
| `52.5.35.215`       | `TCP`/`HTTPS` | `80` |
| `52.5.35.215`       | `TCP`/`HTTPS` | `443` |
| `34.225.45.162`       | `TCP`/`HTTPS` | `80` |
| `34.225.45.162`       | `TCP`/`HTTPS` | `443` |
