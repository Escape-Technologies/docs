...
Refer to the [Authentication](/testing/authentication/) section for more information.
...
Scans can be slowed down using [rate-limiting configuration](/testing/advanced-usage/rate-limiting), though it may impact the scan duration.
