...
The triggered scan will run asynchronously on Escape, and your team will be notified once it is done using your desired [notifications](/testing/integrations) settings.
