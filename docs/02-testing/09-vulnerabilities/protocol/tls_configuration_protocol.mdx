...
Check your TLS configuration to disable old TLS/SSL protocols and enable the latest TLS 1.3 protocol. You can use [mozilla's SSL Configuration Generator](https://ssl-config.mozilla.org/) to generate a new SSL configuration. You can also consult [RFC 9325](https://datatracker.ietf.org/doc/html/rfc9325) or [mozilla's TLS recommendations](https://wiki.mozilla.org/Security/Server_Side_TLS) for more details on how to configure a secure TLS configuration.
