---
title: TLS Configuration Server Defaults
---
...
Check your server's default TLS configuration to protect your server, check your certificates expiraiton dates and renew them if needed. You can use [mozilla's SSL Configuration Generator](https://ssl-config.mozilla.org/) to generate a new SSL configuration. You can also consult [RFC 9325](https://datatracker.ietf.org/doc/html/rfc9325) or [mozilla's TLS recommendations](https://wiki.mozilla.org/Security/Server_Side_TLS) for more details on how to configure a secure TLS configuration.
