---
title: TLS Configuration Ciphers
---
...
Check your TLS ciphers configuration so as to disable old encryption algorithms. You can use [mozilla's SSL Configuration Generator](https://ssl-config.mozilla.org/) to generate a new SSL configuration. You can also consult [RFC 9325](https://datatracker.ietf.org/doc/html/rfc9325) or [mozilla's TLS recommendations](https://wiki.mozilla.org/Security/Server_Side_TLS) and [mozilla's wiki on cipher suites](https://wiki.mozilla.org/Security/Cipher_Suites) for more details on how to configure a secure cryptographic policy.
