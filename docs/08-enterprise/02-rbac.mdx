...
- **Inventory**: The Escape inventory built from the discovered endpoints via the integrations and the crawling.
- **Integrations**: All the integrations that are configured in Escape to discover and enrich your organizational context.
    - [Integrations Docs](/integrations/) or [Jump to your integrations](https://app.escape.tech/integrations/)
