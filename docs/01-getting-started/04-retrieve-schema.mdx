...
Any of the options you pass to the `GraphQLModule.forRoot` method is part of the Apollo configuration object. Thus, you can re-use the [Apollo plugin method](/getting-started/retrieve-schema#fine-tuning) for a fine-tuned access control.
