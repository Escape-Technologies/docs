...
You can setup rate limit in your application settings [(learn more)](https://escape.tech/docs/advanced-usage/parameters#client), though it may have an impact on the scan coverage, as operation can be rate limited.
