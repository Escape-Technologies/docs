---
title: Custom Security Checks Reference
description: All objects available for custom security checks.
---
...
### Example
    ...
    ```
           |  |
| raw | `string` | `True` | (string): The raw HTTP request in [nuclei format]([docs.projectdiscovery.io](https://docs.projectdiscovery.io/templates/protocols/http/raw-http)) |  |
| user | `string` | `False` | The user to use for the request. |  |
...
| Property   | Type       | Required | Description | Reference |
|------------|------------|-----|-------------|-----------|
| trigger | `ResponseIsSuccessfulDetector | ScanTypeDetector | RequestBodyJSONDetector | RequestIsAuthenticatedDetector | ResponseHeadersDetector | SchemaUrlDetector | RequestUserDetector | ResponseDurationDetector | ResponseStatusCodeDetector | SchemaNeedAuthenticationDetector | ResponseBodyJSONDetector | RequestObjectDetector | RequestHeadersDetector | SchemaPathRefDetector | CrudDetector | RequestBodyTextDetector | ResponseObjectDetector | ResponseBodyTextDetector` | `True` | The detectors to trigger the transform, on the request or response. See [Detectors](./detectors) |  |
| mutate | `RequestUserMutator | RequestBodyJSONMutator | RequestBodyTextMutator | RequestObjectMutator | SchemaUrlMutator | RequestHeadersMutator` | `True` | The mutations to apply to the request and replay it. See [Mutators](./mutators) |  |
